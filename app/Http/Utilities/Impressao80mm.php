...
class Impressao80mm
{
    ...
    public function saldo(Configuracao $config, $pagamentos, Cliente $cliente, $saldoAnteriorMais20 = 0)
    {
        ...
        if ($saldoAnteriorMais20 > 0) {
            ...
            $pdf->Cell(18, 1, 'R$ ' . number_format($saldoAnteriorMais20, 2, ',', '.'), 0, 0, 'R', true);
