                                        ...
                                        <li class="p-3">
                                            ...
                                            <div class="dropstart chat-options-btn">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li class="p-2 mt-3"><a class="dropdown-item text-danger fs-20px mt-3 fn-remover" href="javascript:void(0);" data-content="{{ $venda->id }}" data-method="venda" data-id="{{ $venda->id }}"><i class="fad fa-trash fs-16px"></i> Remover</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                    @endforeach
